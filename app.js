...
let budgetController = (function () {
    ...
    let calculateTotal = function (type) {
        let sum = 0;
        data.allItem[type].forEach(current => sum += current.value);
    ...
    return {
        ...
        calculatePercentage: function(){
            data.allItem.exp.forEach(cur => cur.calcPercentage(data.totals.inc));
        },

        getPercentages: function(){
            let allPerc = data.allItem.exp.map(cur => cur.getPercentage());
            return allPerc;
        },
